...
const Hero = ({
  ...
  return (
    <div
      className="max-w-screen-xl px-8 mx-auto mt-24 xl:px-16"
      id="about"
    >
          ...
          <motion.div
            ...
            <div className="flex flex-col items-start justify-center row-start-2 sm:row-start-1">
              <h1 className="text-3xl font-medium leading-normal lg:text-4xl xl:text-5xl text-black-600">
                Design. Develop. Optimize. Repeat. <strong>Meet Ruffolo</strong>.
              </h1>
              <p className="mt-4 mb-6 text-black-500">
                His digital career started 12 years ago with sales/ad copywriting. 
                Since then he's mostly worked with <strong><a className="text-sky-400" href="https://www.typescriptlang.org/docs/handbook/react.html">JS/TSX (React)</a></strong>.
                He's fascinated with <strong><a className="text-sky-400" href="https://www.rust-lang.org/">Rust</a></strong> and <strong><a className="text-sky-400" href="https://en.wikipedia.org/wiki/Web3">Web3</a></strong> disruption.
              </p>
              <ButtonPrimary>My "Now" Page</ButtonPrimary>
            </div>
      ...
      <div className="relative flex w-full">
        <ScrollAnimationWrapper
          className="z-10 grid w-full grid-flow-row grid-cols-1 divide-y-2 divide-gray-100 rounded-lg sm:grid-flow-row sm:grid-cols-3 py-9 sm:divide-y-0 sm:divide-x-2 bg-white-500">
